...
1. `.workflow/design/DESIGN.md`
2. `.workflow/design/user-flow.md`
3. At least one artifact in `.workflow/design/wireframes/`
4. At least one artifact in `.workflow/design/screens/`
5. `.workflow/design/component-guidelines.md`
6. `.workflow/design/design-review.md`
7. `.workflow/traceability.json`
...
- `quick / OPEN_DESIGN_LITE`: create a compact `.workflow/design/DESIGN.md` containing the refined flow, screen structure, key states/interactions, accessibility concerns, and UI-impact risks. Expand to Full or request human review when a material UX choice remains.
